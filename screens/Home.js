        ...
        <ScrollView>
          <View style={[MainStyle.slideHome, { width: ScreenWidth, height: ScreenWidth * this.state.heightSwiper }]}>
            <Swiper autoplay={true} autoplayTimeout={4}>
              {this.state.listSlide.map((item, index) => {
                return (
                  item.cate_id != '' ?
